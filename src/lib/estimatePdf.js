...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .signature-label { color: var(--muted); font-size: 10px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; }
    .signature-space { height: 58px; }
    .signature-name { border-top: 1px solid var(--ink); font-size: 13px; font-weight: 700; padding-top: 8px; }
